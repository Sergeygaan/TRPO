...
{
    class SelectPointActions
    {
        public delegate void MyDelegate(MyPaint.Actions.SelectPointActions foo);


        [Test, TestCaseSource("Cases")]
        public void TestDeleteBackgroundFigure(MyDelegate fooDelegat)
        {
            var foo = Mock.Create<MyPaint.Actions.SelectPointActions>(Constructor.Mocked);
            fooDelegat(foo);
         
        }

        static public void MouseMove(MyPaint.Actions.SelectPointActions foo)
        {
        ...
        static public void MouseUp(MyPaint.Actions.SelectPointActions foo)
        {
        ...
        static public void MouseDown(MyPaint.Actions.SelectPointActions foo)
        {
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, 1, 1, 1, 1);
