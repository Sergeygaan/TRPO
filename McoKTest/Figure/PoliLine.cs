...
namespace McoKTest.Figure
{
    class PoliLine
    {
        public delegate void MyDelegate(MyPaint.Build.PoliLine foo);

        [Test, TestCaseSource("Cases")]
        public void TestPoliLine(MyDelegate fooDelegat)
        {
            var foo = Mock.Create<MyPaint.Build.PoliLine>(Constructor.Mocked);
            fooDelegat(foo);
        }

        static public void MouseMove(MyPaint.Build.PoliLine foo)
        {
        ...
        static public void MouseUp(MyPaint.Build.PoliLine foo)
        {
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
        ...
        static public void MouseDown(MyPaint.Build.PoliLine foo)
        {
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
        ...
        static public void AddFigure(MyPaint.Build.PoliLine foo)
        {
        ...
        static public void AddSupportPoint(MyPaint.Build.PoliLine foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
        ...
        static public void ScaleSelectFigure(MyPaint.Build.PoliLine foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
        ...
        static public void ScaleFigure(MyPaint.Build.PoliLine foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
