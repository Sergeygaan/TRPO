...
namespace McoKTest.Figure
{
    class Ellipses
    {
        public delegate void MyDelegate(MyPaint.Build.Ellipses foo);

        [Test, TestCaseSource("Cases")]
        public void TestEllipses(MyDelegate fooDelegat)
        {
            var foo = Mock.Create<MyPaint.Build.Ellipses>(Constructor.Mocked);
            fooDelegat(foo);
        }

        static public void MouseMove(MyPaint.Build.Ellipses foo)
        {
        ...
        static public void MouseUp(MyPaint.Build.Ellipses foo)
        {
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
        ...
        static public void MouseDown(MyPaint.Build.Ellipses foo)
        {
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
        ...
        static public void AddFigure(MyPaint.Build.Ellipses foo)
        {
        ...
        static public void AddSupportPoint(MyPaint.Build.Ellipses foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
        ...
        static public void ScaleSelectFigure(MyPaint.Build.Ellipses foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
        ...
        static public void ScaleFigure(MyPaint.Build.Ellipses foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
