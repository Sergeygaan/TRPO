...
namespace McoKTest.Figure
{
    class Rectangles
    {
        public delegate void MyDelegate(MyPaint.Build.Rectangles foo);

        [Test, TestCaseSource("Cases")]
        public void TestRectangles(MyDelegate fooDelegat)
        {
            var foo = Mock.Create<MyPaint.Build.Rectangles>(Constructor.Mocked);
            fooDelegat(foo);
        }

        static public void MouseMove(MyPaint.Build.Rectangles foo)
        {
        ...
        static public void MouseUp(MyPaint.Build.Rectangles foo)
        {
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
        ...
        static public void MouseDown(MyPaint.Build.Rectangles foo)
        {
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
        ...
        static public void AddFigure(MyPaint.Build.Rectangles foo)
        {
        ...
        static public void AddSupportPoint(MyPaint.Build.Rectangles foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
        ...
        static public void ScaleSelectFigure(MyPaint.Build.Rectangles foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
        ...
        static public void ScaleFigure(MyPaint.Build.Rectangles foo)
        {
            ObjectFugure objectFugure = new ObjectFugure(new Pen(Color.Aqua), new GraphicsPath(), new Color(), new int(), new bool());
            MouseEventArgs mouse = new MouseEventArgs(MouseButtons.Left, new int(), new int(), new int(), new int());
